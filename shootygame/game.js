...
BasicGame.Game.prototype = {
  ...
  // debugging for hit-boxes (when will an enemy/player take damage)
  // render: function () {
  ...
  checkCollisions: function () {
   ...
   spawnEnemies: function () {
     if (this.nextEnemyAt < this.time.now && this.enemyPool.countDead() > 0) {
           ...
           // spawn at a random location top of the screen with certain hp
           // based off variables (ENEMY_HEALTH = 2)
